...
def process_data():
    ...
    return U, track_name_to_index, track_index_to_name

def generate_recs(song_name, k):
    U, track_name_to_index, track_index_to_name = process_data()
    similarity_scores = []
    if song_name not in track_name_to_index:
        return None
